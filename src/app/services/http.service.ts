...
export class HttpService {
  ...
  getCountriesInfo(): Observable<APIResponse<Country[]>> {
    return this.httpClient.get<APIResponse<Country[]>>(`${env.BASE_URL}/countries`);
  }

  getcountryByCode(countryCode: string): Observable<APIResponse<Country>> {
    return this.httpClient.get<APIResponse<Country>>(`${env.BASE_URL}/countries/${countryCode}`);
  }
}
